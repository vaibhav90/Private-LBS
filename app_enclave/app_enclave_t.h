#ifndef APP_ENCLAVE_T_H__
#define APP_ENCLAVE_T_H__
...
float enclaveLoadVal();
int encrypt_result();
void payload_to_buf(uint8_t* buf, size_t len);
void mac_tag_to_buf(sgx_aes_gcm_128bit_tag_t* buf, size_t len);
